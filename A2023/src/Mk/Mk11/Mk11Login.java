...
public class Mk11Login extends Mk11Initializer implements KeyListener, MouseListener {
    ...
    ///判断用户名是否重复
    public static boolean checkSameUsername(ArrayList<Mk11User> library, String username) {
