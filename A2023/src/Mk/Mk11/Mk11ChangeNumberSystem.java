...
public class Mk11ChangeNumberSystem extends Mk11Initializer implements MouseListener, FocusListener, KeyListener {
    ...
    public Mk11ChangeNumberSystem(String username) {
