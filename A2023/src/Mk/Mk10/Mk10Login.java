...
public class Mk10Login extends Mk10Initializer implements KeyListener, MouseListener {
    ...
    ///判断用户名是否重复
    public static boolean checkSameUsername(ArrayList<Mk10User> library, String username) {
